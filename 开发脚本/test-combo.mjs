...
new Function('document','localStorage','requestAnimationFrame','fetch',
  code + '\nglobalThis.T={state,recommend,planMeal,buildCombo,restaurantServes,hardFilter,ROLE_LABEL,ROLE_EMOJI,DISHES,RESTAURANTS,recommendRestaurantsSmart,TIERS,sourceLabel};')
